...
public class Title extends JPanel {
	...
	if (duoCompetition)
	    drawStringCenterOfPanel(g, color, 16, StringPadding.getRPad("◀ Human VS Human Competition", 15, " "),
		    firstLine += 40);
	else
	...
	if (aiCompetition)
	    drawStringCenterOfPanel(g, color, 16, StringPadding.getRPad("◀ Human VS Neo Competition", 15, " "),
		    firstLine += 40);
	else
